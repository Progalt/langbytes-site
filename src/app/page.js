...
export default async function Home() {
  ...
  return (
    <main className="w-full min-h-screen flex flex-col relative">
      <div className="background-svg opacity-25 bg-[length:200%] md:bg-[length:120%]" />
      <UserNav/>
      <div className="flex flex-col flex-grow justify-between transition-transform duration-150">
        <section className="px-5 md:mt-14 w-full flex flex-col justify-start md:justify-center items-center">
          ...
          <div className="w-full md:w-[80%] lg:w-[60%] 2xl:w-[40%]">
              <section className="flex flex-col justify-center items-center">
                <header className=" mt-10 md:mb-14">
                  <h1 className="text-4xl md:text-6xl font-semibold">
                    Quickly get problems to test your
                    <span className={"font-extrabold text-indigo-400 italic "}> coding skills.
                    </span>
                  </h1>
          ...
          <hr className="w-[90%] md:w-[70%] border-[1px] rounded-full border-[#232333]"></hr>
          <article className="w-full h-full md:w-[80%] lg:w-[60%] 2xl:w-[40%] mt-20 md:flex md:flex-row md:flex-grow md:items-center">
            <section className="md:w-[50%] ">
              <h3 className="mb-2 text-slate-300 italic font-light">Fancy a challenge?</h3>
              <h2 className="text-3xl md:text-4xl font-semibold">Complete a <span className="font-extrabold italic text-indigo-400">Daily challenge</span></h2>
            ...
            <section className="md:w-[50%] mt-10 mb-10 flex flex-row justify-center items-center">
